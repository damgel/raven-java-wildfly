package br.com.tecnobiz.raven.wildfly;
 ...
 *
 */
public class JbossLoggingSentryHandler extends SentryHandler {

    private static final Logger LOGGER = LoggerFactory
	    .getLogger(JbossLoggingSentryHandler.class);

    public JbossLoggingSentryHandler() {

    }

    public JbossLoggingSentryHandler(Raven raven) {
	super(raven);
    }
